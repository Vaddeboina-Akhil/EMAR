...
const { requestAccess, getPatientConsents, respondConsent, getAccessLogs, getConsentsByDoctor, seedTestLogs, migrateAccessLogs, getAccessLogStats } = require('../controllers/consentController');
